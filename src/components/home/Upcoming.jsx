...
const Upcoming = () => {
  return (
    <div className='pb-[6rem] bg-brand'>
        <div className="upcoming bg-gradient-to-r from-blue-300  to-yellow-600 w-full md:h-[95vh] h-[50vh] md:p-[4rem] p-[1.5rem] flex items-center justify-center flex-col">
